...
input_dir = '/home/usuario/Documentos/GBM/Samples/PC_SegmentationSet/test/PC/'
mask_dir = '/home/usuario/Documentos/GBM/Samples/PC_SegmentationSet/test/Mask/'
...
image_generator = image_datagen.flow_from_directory(
    input_dir,
    class_mode=None, target_size=target_size,  batch_size=1,
    seed=1)
...
def soft_dice_loss(y_true, y_pred, epsilon=1e-6): 
    ...
    resultado = 1 - np.mean((numerator + epsilon) / (denominator + epsilon))
    print(resultado)
    
    return resultado# average over classes and batch
...
model.compile(optimizer='adam',
              loss=soft_dice_loss, run_eagerly=True)
