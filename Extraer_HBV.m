...
path_wsi=[main_path,'/WSI/validation/'];
path_segmentation=[main_path,'/SG/validation/'];
...
%     num_paches_table=table(Name,LE,IT,CT,NE,HB,PC,MV);
   ...
   writetable(num_paches_table,'/home/usuario/Documentos/GBM/TablePatches3.xlsx','Sheet','valid');
...
%             [PCrnn_maskcoord,coord_nn] = crop_patches(PCrnn,scale,stride);  
    ...
    %%%% Saving Patches
    path_region = ['/home/usuario/Documentos/GBM/Samples/samples_224x224/val/',region,'/'];
