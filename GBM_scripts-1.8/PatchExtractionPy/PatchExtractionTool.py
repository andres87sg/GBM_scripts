...
df = pd.read_excel(ExtrationParams, sheet_name='ValCT_PC')

# Ruta principal y ruta de destino
mainpath = '/home/usuario/Documentos/GBM/IvyGap/'
destpath='/home/usuario/Documentos/GBM/Samples/Nuevo/val/'
...
table.to_excel('TValidation.xlsx',sheet_name='Val')
